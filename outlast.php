...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/outlast.css">
...
<body>
	<div class="wrapper">
		...
		<div id="destaque"> 
				<h1 >OUTLAST</h1>
				<p>
				Inferno é um experimento que você não pode sobreviver em Outlast, um jogo de terror de sobrevivência na primeira pessoa desenvolvido por veteranos de algumas das maiores franquias de jogos da história. Como o jornalista investigativo Miles Upshur, explore o Mount Massive Asylum e tente sobreviver tempo suficiente para descobrir o seu terrível segredo ...</p>
